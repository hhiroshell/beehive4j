...
public class BeehiveApiDefinitions {
    ...
    public static final Class<BkrsReadBatchInvoker> TYPEDEF_BKRS_READ_BATCH =
            BkrsReadBatchInvoker.class;

    public static final Class<InvtCreateInvoker> TYPEDEF_INVT_CREATE =
            InvtCreateInvoker.class;
    ...
    public static final Class<InvtReadInvoker> TYPEDEF_INVT_READ =
            InvtReadInvoker.class;
